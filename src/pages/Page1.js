...
const Page1 = () => {
  ...
  return (
    <>
      ...
      <ColorText1 color="blue" fontSize="20px" text="適当に１．．．" />
      {/* 開始タグ、終了タグで囲って値を設定 */}
      <ColorText2 color="blue" fontSize="10px">
        <li>適当に２．．．</li>
      </ColorText2>

      <button onClick={() => alert('くりっくしたよ')}>もんごん１</button>
      <button onClick={clk}>もんごん２</button>
